...
#define STRING_CONFIG_H_AUTHOR "(Bert)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Bert\'s i3"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,90}  // Bert
...
#define SERVO_ENDSTOP_ANGLES {{0,0}, {0,0}, {10,90}} // X,Y,Z Axis Extend and Retract angles - Bert BLTouch
// #define SERVO_ENDSTOP_ANGLES {{0,0}, {0,0}, {10,140}} // X,Y,Z Axis Extend and Retract angles - Bert Servo
